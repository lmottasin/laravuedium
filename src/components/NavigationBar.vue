        ...
        <div class="flex h-16 justify-between">
          <div class="flex">
            <div class="flex flex-shrink-0 items-center">
              <a href="/">
                <h2 class="font-bold text-2xl">Laravuedium</h2>
              </a>
            </div>
                ...
                <button
                  ...
                  :class="
                    isProfileDropdownOpen
                      ? 'flex rounded-full bg-white text-sm outline-none ring-2 ring-gray-500 ring-offset-2'
                      : 'flex rounded-full bg-white text-sm'
                  "
                  id="user-menu-button"
                  aria-expanded="false"
                  aria-haspopup="true"
